...
def parse_arguments():
    ...
    parser.add_argument('--learning-start', type=int, default=5000, help="Number of iterations before start training")
    ...
    parser.add_argument('--target-update', type=int, default=16*50, help="Update target network after this many steps")
...
def main():
    ...
    agent = DQNAgent(env,
                     ...
                     value_dist_size=args.value_dist_size,
                     v_min=args.vmin,
                     v_max=args.vmax,
                     device=args.device)
    ...
    priority_weight_increase = (1 - args.priority_weight) / (args.max_steps - args.learning_start)

    # # Validation memory
    # validation_memory = ReplayMemory(capacity=args.evaluation_size,
    #                                  device=args.device,
    #                                  discount=args.discount,
    #                                  multi_step=args.multi_step,
    #                                  priority_weight=args.priority_weight,
